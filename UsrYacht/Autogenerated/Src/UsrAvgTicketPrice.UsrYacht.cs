namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrAvgTicketPriceMethodsWrapper

	/// <exclude/>
	public class UsrAvgTicketPriceMethodsWrapper : ProcessModel
	{

		public UsrAvgTicketPriceMethodsWrapper(Process process)
			: base(process) {
